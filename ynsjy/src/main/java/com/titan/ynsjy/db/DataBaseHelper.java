...
public class DataBaseHelper {
    ...
    public static Map<String, List<String>> getLayerData(final Context context, String id) {
        ...
        try {
            ...
            Database db = new jsqlite.Database();
            db.open(databaseName, jsqlite.Constants.SQLITE_OPEN_READWRITE);
            String sql = "select * from fxh where PK_UID =" + id;
            db.exec(sql, new Callback() {
                @Override
                public void columns(String[] strings) {
                    Collections.addAll(nameList, strings);
                ...
                @Override
                public boolean newrow(String[] strings) {
     ...
     * @param context
     * @param ydh     ���غ�
     * @param zbtype  ֲ������ 0 Ϊ������Ϣ���� �������˵�� ��������λ�� �����ܸǶ����� ɭ��������� ֲ������ ��Ϣ 1Ϊ��ľ��Ϣ
     *                2Ϊ�ݱ���Ϣ 3Ϊ�ر�����Ϣ
     * @return
     */
     ...
     *
     * @param context
     * @param zbtypeֲ������ 0 Ϊ������Ϣ���� �������˵�� ��������λ�� �����ܸǶ����� ɭ��������� ֲ������ ��Ϣ 1Ϊ��ľ��Ϣ 2Ϊ�ݱ���Ϣ
     *                      3Ϊ�ر�����Ϣ
     */
