 ...
 * 
 */
public class LDStatisticsActivity extends Activity {
	ListView mListView1;
	MyAdapter myAdapter;
	RelativeLayout mHead;
	LinearLayout main;
	Button btn_excel;
	ArrayList<LDAreaSum> data;

	@SuppressWarnings("unchecked")
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ld_tongji);
		...
		myAdapter = new MyAdapter(this, R.layout.ld_item);
		data = (ArrayList<LDAreaSum>) getIntent().getExtras().getSerializable(
				"data");

		mListView1.setAdapter(myAdapter);
		myAdapter.setData((ArrayList<LDAreaSum>) getIntent().getExtras()
	...
	public class MyAdapter extends BaseAdapter {
		...
		public void setData(ArrayList<LDAreaSum> data) {
			this.data = data;
		...
		public View getView(int position, View convertView, ViewGroup parentView) {
			...
			if (convertView == null) {
				...
				convertView = mInflater.inflate(R.layout.ld_item, null);
			...
			holder.txt4.setText(String.format("%.2f",Double.valueOf(data.get(position).zmj)));
			...
			holder.txtm11.setText(String.format("%.2f",
					Double.valueOf(data.get(position).rgzlwclzld)));
			holder.txtm12.setText(String.format("%.2f",
					Double.valueOf(data.get(position).fywcld)));
	...
	public void excel(ArrayList<LDAreaSum> data) {
		...
		try {
			...
			Label label_titl_08 = new Label(7, 2, "竹林", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_09 = new Label(8, 1, "疏林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_gmld = new Label(9, 1, "灌木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_10 = new Label(9, 2, "小计", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_gjtbgm = new Label(10, 2, "国家特别灌木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_11 = new Label(10, 3, "小计", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(10, 3, 10, 3);
			sheet.setColumnView(10, 15);

			Label label_titl_12 = new Label(11, 3, "灌木经济林", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(11, 3, 11, 3);
			sheet.setColumnView(11, 20);

			Label label_titl_13 = new Label(12, 2, "其它灌木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_wclzld = new Label(13, 1, "未成林造林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_14 = new Label(13, 2, "小计", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_15 = new Label(14, 2, "人造林未成林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_16 = new Label(15, 2, "封育未成林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_17 = new Label(16, 1, "苗圃地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(16, 1, 16, 3);
			sheet.setColumnView(16, 20);

			Label label_titl_wlmld = new Label(17, 1, "无立木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_18 = new Label(17, 2, "小计", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_19 = new Label(18, 2, "采伐迹地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_20 = new Label(19, 2, "火烧迹地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_21 = new Label(20, 2, "其他无立木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_Yld = new Label(21, 1, "宜林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			sheet.addCell(label_titl_Yld);
			// 合并单元格第一个参数：要合并的单元格最左上角的列号，
			// 第二个参数：要合并的单元格最左上角的行号，
			...
			Label label_titl_22 = new Label(21, 2, "小计", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_23 = new Label(22, 2, "荒山荒地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_24 = new Label(23, 2, "沙荒地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_25 = new Label(24, 2, "其他宜林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_26 = new Label(25, 1, "辅助生产林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(25, 1, 25, 3);
			sheet.setColumnView(25, 20);

			Label label_titl_flyyd = new Label(26, 0, "非林业用地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(26, 0, 35, 0);

			Label label_titl_27 = new Label(26, 1, "合计", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(26, 1, 26, 3);
			sheet.setColumnView(26, 15);

			Label label_titl_28 = new Label(27, 1, "有林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(27, 1, 27, 3);
			sheet.setColumnView(27, 20);

			Label label_titl_fylgmld = new Label(28, 1, "灌木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			// 第三个参数：要合并的单元格最右角的列号，
			// 第四个参数：要合并的单元格最右下角的行号，
			sheet.mergeCells(28, 1, 30, 1);

			Label label_titl_29 = new Label(28, 2, "小计", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_30 = new Label(29, 2, "国家特别规定灌木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			Label label_titl_31 = new Label(30, 2, "其他灌木林地", titlewcf);
			// 将定义好的单元格添加到工作表中
			...
			for (int i = 4; i < hang + 4; i++) {
				...
				jxl.write.Number numberm11 = new jxl.write.Number(14, i,
						Double.valueOf(data.get(i - 4).rgzlwclzld), datawcf);
				sheet.addCell(numberm11);

				jxl.write.Number numberm12 = new jxl.write.Number(15, i,
						Double.valueOf(data.get(i - 4).fywcld), datawcf);
				...
				jxl.write.Number numberm18 = new jxl.write.Number(21, i,
						Double.valueOf(data.get(i - 4).yildxj), datawcf);
				...
				jxl.write.Number numberm20 = new jxl.write.Number(23, i,
						Double.valueOf(data.get(i - 4).shd), datawcf);
				sheet.addCell(numberm20);

				jxl.write.Number numberm21 = new jxl.write.Number(24, i,
						Double.valueOf(data.get(i - 4).qtyld), datawcf);
