...
//        }
    ...
    private void initMapView() {
        ...
        mLoctionDisplayManager.setAutoPanMode(LocationDisplayManager.AutoPanMode.NAVIGATION);
    ...
    private class MyTouchListener extends MapOnTouchListener {
        ...
        public boolean onSingleTap(MotionEvent e) {
            ...
            if (actionMode == ActionMode.MODE_QIEGE && drawType == POLYLINE) {
                ...
                BaseActivityPermissionsDispatcher.addCalloutPointWithCheck(BaseActivity.this,map,mapPoint);
            }
            return true;
        }
