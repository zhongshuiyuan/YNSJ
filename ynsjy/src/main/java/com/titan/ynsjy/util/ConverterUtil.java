...
public class ConverterUtil {
     ...
     *  @author jf.gong  DateTime 2014骞�鏈�鏃�涓婂崍11:31:44
     *  @return boolean 
     *  @param lat
     *  @param lng
     *  @return
     ...
     *  @Title: transformLat 
     *  @Description: 纬度转换
     *  @author jf.gong  DateTime 2014骞�鏈�鏃�涓婂崍11:32:21
     *  @return double 
     *  @param x
     *  @param y
     *  @return
     ...
     *  @Title: transformLng 
     *  @Description: 经度转换
     *  @author jf.gong  DateTime 2014骞�鏈�鏃�涓婂崍11:32:33
     *  @return double 
     *  @param x
     *  @param y
     *  @return
     ...
     *  @author jf.gong  DateTime 2014骞�鏈�鏃�涓嬪崍12:25:06
     *  @return Point 
     *  @param xx
     *  @param yy
     *   @param mapType 
     ...
     *  @author jf.gong  DateTime 2014骞�鏈�鏃�涓嬪崍12:24:40
     *  @return byte[] 
     *  @param str
     *  @return
     */
...
//    } 
     ...
     *  @Title: getWantDouble 
     *  @Description: 保留小数位
     *  @author jf.gong  DateTime 2014骞�鏈�鏃�涓嬪崍5:43:57
     *  @return double 
     *  @param val
     *  @param unit  澶氬皯灏忔暟浣�
     *  @return
