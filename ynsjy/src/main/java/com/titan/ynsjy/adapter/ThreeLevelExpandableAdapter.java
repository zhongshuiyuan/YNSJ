...
public class ThreeLevelExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public ThreeLevelExpandableAdapter(Context context,OnItemClickListener listener) {
        mContext = context;
        mListener = listener;
    }
    ...
    private  class ChildExpandableListAdapter extends BaseExpandableListAdapter {
