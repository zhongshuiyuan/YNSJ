 ...
 * strings.
 * <p>
 * The primary use of this class is to represent coordinate values which are to
 * be transformed by a {@link CoordinateTransform}.
 */
public class ProjCoordinate {
	 ...
	 * <tt>Double.NaN</tt> then this coordinate does not have a Z value.
	 * <p>
	 * Note: This member variable can be accessed directly. In the future this
	 * direct access should be replaced with getter and setter methods. This
	 * will require refactoring of the Proj4J code base.
	 ...
	 * or <tt>[X, Y, Z]</tt>. Z is not displayed if it is NaN.
	 * <p>
	 * Example:
	 * 
	 * <pre>
